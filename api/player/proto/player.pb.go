...
type UserHCData struct {
	...
	HcGiftsClaimed int32                  `protobuf:"varint,2,opt,name=hc_gifts_claimed,json=hcGiftsClaimed,proto3" json:"hc_gifts_claimed,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *UserHCData) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *UserHCData) GetLastHcPayday() int32 {
	if x != nil {
		return x.LastHcPayday
	}
	return 0
}

func (x *UserHCData) GetHcGiftsClaimed() int32 {
	if x != nil {
		return x.HcGiftsClaimed
	}
	return 0
}
...
const file_player_proto_rawDesc = "" +
	...
	"\x10hc_gifts_claimed\x18\x02 \x01(\x05R\x0ehcGiftsClaimed\"_\n" +
	"\n" +
	"LoginEvent\x12\x0e\n" +
